	...
	<div class="footer-nav">
		<div class="container clearfix">
			...
			<div class="footer-nav__col footer-nav__col--contacts">
				...
				180-182 Tom mboya Street, Nairobi.
			</address>
				<div class="phone">
					Telephone:
					<a class="phone__number" href="tel:071234453">0123-456-789</a>
				</div>
				<div class="email">
					Email:
					<a href="mailto:support@yourwebsite.com" class="email__addr">support@martosimel.com</a>
				</div>
			</div>
